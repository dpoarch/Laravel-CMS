...
<html lang="en">
   <head>
      ...
      <title>HSync Administrator Dashboard CRUD</title>
      <!-- plugins:css -->
      <link rel="stylesheet" href="../assets/vendors/iconfonts/mdi/css/materialdesignicons.css">
      <link rel="stylesheet" href="../assets/vendors/css/vendor.addons.css">
      <!-- endinject --><!-- vendor css for this page -->
      <link rel="stylesheet" href="../assets/vendors/iconfonts/flag-icon-css/css/flag-icon.min.css">
      <!-- End vendor css for this page --><!-- Layout style -->
      <link rel="stylesheet" href="../assets/css/demo_2/style.css">
   </head>
   <body class="header-fixed">
      <nav class="t-header">
         <div class="t-header-brand-wrapper">
            <a href="/"><span class="logo">HSYNC</span> <span class="logo-mini">HC</span><!-- <img class="logo-mini" src="../assets/images/logo_mini.svg" alt=""> --> </a>
         ...
         <div class="t-header-content-wrapper">
            <div class="t-header-content">
               ...
               <ul class="nav ml-auto">
                  ...
                  <li class="nav-item dropdown">
                     <a class="nav-link" href="#" id="appsDropdown" data-toggle="dropdown" aria-expanded="false"><i class="mdi mdi-apps mdi-1x"></i></a>
      ...
      <div class="page-body">
         ...
         <div class="sidebar">
            <ul class="navigation-menu">
               ...
               <li><a href="/"><span class="link-title">Dashboard</span> <i class="mdi mdi-gauge link-icon"></i></a></li>
               <li><a href="/positions"><span class="link-title">Positions</span> <i class="mdi mdi mdi-account-star link-icon"></i></a></li>
               <li><a href="/products"><span class="link-title">Accounts</span> <i class="mdi mdi mdi mdi-account-outline link-icon"></i></a></li>
            </ul>
            <div class="sidebar_footer">
               <div class="user-account">
                  <div class="user-profile-item-tittle">User Account</div>
              
                  <a class="user-profile-item" href="#"><i class="mdi mdi-account"></i> Profile</a> <a class="user-profile-item" href="#"><i class="mdi mdi-settings"></i> Account Settings</a> <a class="btn btn-primary btn-logout" href="{{ route('logout') }}"
               ...
               <div class="btn-group admin-access-level">
                  <div class="avatar"><img class="profile-img" src="../{{ Auth::user()->profile }}" alt=""></div>
